...
namespace Blockify.Api.Configuration
{
    public class ApplicationConfigurator
    {
        ...
        public void ConfigureServices()
        {
            ...
            _services.AddAuthentication("default_cookie")
                .AddCookie("default_cookie", options =>
                {
                ...
                {
                    options.ClientId = _configuration["Api:OAuth:Spotify:ClientId"] ??
                                        throw new MissingConfigurationException("Spotify Client Id");

                    options.ClientSecret = _configuration["Api:OAuth:Spotify:ClientSecret"] ??
